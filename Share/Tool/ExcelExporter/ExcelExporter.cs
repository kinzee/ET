...
namespace ET
{
    public static class ExcelExporter
    {
        ...
        public static void Export()
        {
            ...
            string shellFilePath = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? ".\\gen_all.bat" : "./gen_all.sh";
            Process configProcess = CreateProcess(shellFilePath, "../Share/Tool/Luban/");
